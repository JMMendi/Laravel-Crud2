...
<div class="my-2 p-2 rounded-xl shadow-xl border-2 border-black">
    <form action="{{route('articles.store')}}" method="POST" class="max-w-sm mx-auto">
        @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="radio" @checked(@old('disponible')) name="disponible" id="disponible" value="SI" class="ml-5 mr-2">SI
            <input type="radio" @checked(@old('disponible')) name="disponible" id="disponible" value="NO" class="ml-5 mr-2">NO
            @error('disponible')
            <x-error>
                {{$message}}
            </x-error>
